...
<!-- Search Section -->
<div class="content">
    <!-- Icon search functionality initialized in js/pages/base_ui_icons.js -->
...
<div class="content">
    ...
    <div class="block">
        <div class="block-header">
            <h3 class="block-title">Font Awesome <small>519 icons with base class <code>fa</code></small></h3>
        </div>
        <div class="block-content">
            <div class="js-icon-list row items-push-2x text-center">
                <div class="col-sm-6 col-lg-3">
